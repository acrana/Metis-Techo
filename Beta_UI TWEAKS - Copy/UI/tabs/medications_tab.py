...
class MedicationsTab(QWidget):
    ...
    def setup_ui(self):
        """Create the medications management tab"""
        layout = QHBoxLayout(self)
        
        # Left side - Current Medications & Order Panel
        left_panel = QWidget()
    ...
    def on_medication_select(self, index):
        """Handle medication selection and update risk assessment"""
    ...
    def update_interactions_table(self, interactions):
        """Update drug interactions table"""
    ...
    def update_contraindications_table(self, contraindications):
        """Update contraindications table"""
