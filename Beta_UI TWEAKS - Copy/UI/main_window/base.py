...
class CDSSUI(QMainWindow, PatientHandlersMixin, MedicationHandlersMixin):
    ...
    def create_header_section(self, parent_layout):
        """Create the header section with compact layout and adjusted icon size."""
        header = QWidget()
        ...
        # Icon and "METIS" label container
        ...
        # "METIS" label in Greek-inspired style
        ...
        greek_font = QFont(greek_font_family, 10, QFont.Bold)  # Smaller font to reduce height

        metis_label = QLabel("METIS")  # Romanized
        ...
        # Add spacer to control distance between dark mode and icon
        spacer = QWidget()
        spacer.setFixedWidth(10)  # Smaller spacer to save space
        header_layout.addWidget(spacer)

        # Add icon and "METIS" label
